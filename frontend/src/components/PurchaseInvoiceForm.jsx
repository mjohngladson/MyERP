      ...
      <div className="bg-white rounded-lg shadow-sm border p-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
          ...
          <div>
            ...
            <select value={inv.supplier_id} onChange={(e)=>{ const s = supplierList.find(x=>x.id===e.target.value); if(s) selectSupplier(s); else setInv(prev=>({...prev, supplier_id: e.target.value})); }} className="w-full px-3 py-2 border rounded-md">
