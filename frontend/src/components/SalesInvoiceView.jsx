...
const SalesInvoiceView = ({ invoiceId, initialInvoice, onBack }) => {
          ...
          <>
            ...
            <div className="flex items-start justify-between">
              ...
              <div className="text-right text-sm text-gray-600">
                ...
                <div>Date: {invoice.invoice_date ? new Date(invoice.invoice_date).toLocaleDateString('en-IN') : (invoice.created_at ? new Date(invoice.created_at).toLocaleDateString('en-IN') : '-')}</div>
