...
import { Plus, Search, Filter, Eye, Edit, Trash2, Calendar, User, DollarSign, ChevronLeft, FileText, TrendingUp, Send } from 'lucide-react';
              ...
              <div key={inv.id} className="px-6 py-4 hover:bg-gray-50">
                <div className="grid grid-cols-12 gap-4 items-center">
                  ...
                  <div className="col-span-1"><div className="flex items-center space-x-2">
                    ...
                    {(inv.status === 'submitted' || inv.status === 'paid') && <button onClick={()=>{ setSendModal(inv); setSendContact(inv.supplier_email || inv.supplier_phone || ''); }} className="p-1 hover:bg-gray-100 rounded-md" title="Send"><Send size={16} className="text-gray-600"/></button>}
