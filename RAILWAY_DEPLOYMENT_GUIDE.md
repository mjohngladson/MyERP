...
3. **Add the following environment variable:**
   ...
   - Value: `https://retail-erp.preview.emergentagent.com` (or your backend URL)
...
2. **Test the login functionality:**
   ...
   - Verify the API call goes to: `https://retail-erp.preview.emergentagent.com/api/auth/login`
