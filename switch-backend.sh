...
switch_to_preview() {
    ...
    sed -e 's|^REACT_APP_BACKEND_URL=.*|REACT_APP_BACKEND_URL=https://gili-erp-fix.preview.emergentagent.com|' \
        -e 's|^# REACT_APP_BACKEND_URL=https://gili-erp-fix.preview.emergentagent.com|REACT_APP_BACKEND_URL=https://gili-erp-fix.preview.emergentagent.com|' \
    ...
    echo -e "${GREEN}✓ Backend URL: https://gili-erp-fix.preview.emergentagent.com${NC}"
}
