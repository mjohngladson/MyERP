...
switch_to_preview() {
    ...
    sed -e 's|^REACT_APP_BACKEND_URL=.*|REACT_APP_BACKEND_URL=https://retail-nexus-18.preview.emergentagent.com|' \
        -e 's|^# REACT_APP_BACKEND_URL=https://retail-nexus-18.preview.emergentagent.com|REACT_APP_BACKEND_URL=https://retail-nexus-18.preview.emergentagent.com|' \
    ...
    echo -e "${GREEN}✓ Backend URL: https://retail-nexus-18.preview.emergentagent.com${NC}"
}
