...
- ❌ Console log shows: `Using backend URL from env: https://gili-erp-fix.preview.emergentagent.com`
...
```bash
./fix-backend-url.sh https://gili-erp-fix.preview.emergentagent.com
```
...
# Your URL: https://gili-erp-fix.preview.emergentagent.com
```
