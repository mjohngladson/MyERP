...
|------------|-----|----------|
| **Preview** | `https://erp-accounting-8.preview.emergentagent.com` | Emergent platform preview/testing |
...
**For Preview:**
```bash
curl https://erp-accounting-8.preview.emergentagent.com/api/
```
...
✓ Backend URL: https://erp-accounting-8.preview.emergentagent.com
