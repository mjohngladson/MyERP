...
|------------|-----|----------|
| **Preview** | `https://erp-integrity.preview.emergentagent.com` | Emergent platform preview/testing |
...
**For Preview:**
```bash
curl https://erp-integrity.preview.emergentagent.com/api/
```
...
✓ Backend URL: https://erp-integrity.preview.emergentagent.com
